      ...
      <div class="card">
        ...
        <div class="form-row">
          ...
          <div class="form-group" style="flex:0 0 240px">
            <label class="form-label">Icon (emoji or image)</label>
            <div class="cjs-icon-upload" data-icon-upload data-icon-target="skl-icon" data-icon-kind="skill">
              <span class="cjs-icon-preview" data-icon-preview></span>
              <input type="text" id="skl-icon" value="${_esc(s.icon||'⚔️')}" placeholder="emoji or image URL">
